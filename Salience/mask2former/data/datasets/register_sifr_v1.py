...
def get_sifr_dicts(root,mode):
    root = Path(root)
    json_file =  f"path/QAGNet-main/coco_dataset/test/val2014/instances_val2014.json"
    # json_file = "path/QAGNet-main/coco_dataset/annotations/instances_val2014.json"
    ...
    for idx, anno in enumerate(imgs_anns):
        ...
        new_val_path = Path("path/QAGNet-main/coco_dataset/val2014")
...
if __name__ == "__main__":
    ...
    root='path/QAGNet-main/coco_dataset'
