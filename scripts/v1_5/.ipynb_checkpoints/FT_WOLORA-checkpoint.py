...
def main(args):
    ...
    # Fixed human prompt for JSON record (this remains constant regardless of the generation prompt)
    fixed_human_prompt = (
    ...
    for idx, img_path in enumerate(image_list):
        ...
        # Use the provided prompt for model generation.
        # If the special <image> token is missing, append it.
    ...
    output_path = "record_raw_vizwiz.json"
